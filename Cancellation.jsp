...
<form action="view.jsp">
	<p class="head2" style = "margin: 20px">Kindly Enter You PRN for Canceling the Reservation :</p>
	<input class="form-control me-2" type="text" placeholder="Search PRN" name="prn" aria-label="Search">
	<br>
	<button type="submit" class="btn btn-outline-success btn-lg">View Details</button>
</form>
</div>
</body>
</html>