...
<body style = "font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  ...
  <div class="container background">
    <h1>Welcome To Online Railway Reservation System</h1>
    <p class="head2" style = "margin: 20px">Kindly select an option:</p>
    <a href="login.jsp">
      <div class="btn btn-outline-success btn-lg">Admin Login</div>
    </a>
    <a href="Userlogin.jsp">
      <div class="btn btn-outline-success btn-lg">User Login</div>
    </a>
  </div>
</body>
